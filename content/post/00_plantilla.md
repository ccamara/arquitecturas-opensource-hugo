...
Copia y pega este documento.

Para escribir se usa Markdown, un formato de texto plano que, a través de códigos muy sencillos (fáciles de recordar y leer), permite crear textos ricos con formatos, hipervínculos, imágenes, listados, tablas, índices automáticos (ver table of contents más a bajo)...

Por ejemplo, para escribir en **negrita** basta con escribir dos * al principio y al final del texto. que quieras poner en negrita.

Los hipervínculos se escriben así: [este es el texto que aparecerá enlazado](http://usj.es)

Hay un montón de opciones, así que te copio la ayuda oficial:
